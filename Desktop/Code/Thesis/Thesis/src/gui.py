...
class GUIApp:
    ...
    """
    def __init__(self, node_cmd=None, node_cwd=None, url="http://localhost:8080/", port=8080):
        project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
        self.node_cmd = node_cmd or ["npm", "run", "dev"]
        self.node_cwd = node_cwd or os.path.join(project_root, "GUI")
        self.url = url
        self.port = port
